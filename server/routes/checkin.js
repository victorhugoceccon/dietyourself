...
const checkInSchema = z.object({
  ...
  nivelEnergia: z.number().int().min(1).max(5).optional().nullable(),
  qualidadeSono: z.number().int().min(1).max(5).optional().nullable(),
  humorGeral: z.number().int().min(1).max(5).optional().nullable(),
  aguaLitros: z.number().min(0).max(10).optional().nullable(),
  treinoMinutos: z.number().int().min(0).max(600).optional().nullable(),
  passos: z.number().int().min(0).max(100000).optional().nullable(),
  aguaMetaLitros: z.number().min(0).max(10).optional().nullable(),
  treinoPlanejado: z.boolean().optional().nullable(),
  focoDia: z.string().max(40).optional().nullable(),
    ...
    if (existingCheckIn) {
      ...
      checkIn = await prisma.dailyCheckIn.update({
        ...
        data: {
          ...
          nivelEnergia: validatedData.nivelEnergia ?? null,
          qualidadeSono: validatedData.qualidadeSono ?? null,
          humorGeral: validatedData.humorGeral ?? null,
          aguaLitros: validatedData.aguaLitros ?? null,
          treinoMinutos: validatedData.treinoMinutos ?? null,
          passos: validatedData.passos ?? null,
          aguaMetaLitros: validatedData.aguaMetaLitros ?? null,
          treinoPlanejado: validatedData.treinoPlanejado ?? null,
          focoDia: validatedData.focoDia ?? null,
